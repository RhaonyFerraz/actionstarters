...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', ...props }, ref) => {
    ...
    const variants: Record<string, string> = {
      primary: 'bg-white text-black hover:bg-gray-200 shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all active:scale-95',
      ...
      glass: 'glass-button text-white neon-bloom-white active:scale-95',
