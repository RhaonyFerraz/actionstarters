  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Gestão Estratégica" className="max-w-4xl">
      <div className="flex flex-col space-y-6 pt-4">
                ...
                <button 
                  ...
                  className={cn(
                    ...
                    currentLvl >= maxLvl 
                      ...
                      : canAfford 
                        ? "bg-black/40 border border-neon-cyan/40 text-neon-cyan hover:bg-neon-cyan/10 hover:border-neon-cyan hover:shadow-[0_0_20px_rgba(0,255,255,0.2)] active:scale-95 shadow-lg" 
        ...
        {/* Wallet Indicator (Cyan/White) */}
        <div className="flex justify-center pt-4">
          <div className="bg-neon-cyan/5 px-6 py-2 rounded-full border border-neon-cyan/20">
             <span className="text-[10px] text-neon-cyan/60 uppercase font-black tracking-widest mr-2">Disponível:</span>
